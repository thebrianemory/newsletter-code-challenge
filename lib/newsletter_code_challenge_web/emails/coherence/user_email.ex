...
defmodule NewsletterCodeChallengeWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: NewsletterCodeChallengeWeb.Coherence.EmailView, layout: {NewsletterCodeChallengeWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
